        ...
        <div>
            <div className="flex justify-between p-4 w-9/12 mx-auto rounded-md mt-5 shadow-lg">
                <div className="flex gap-5">
                    <div className="w-52 h-32 border overflow-hidden rounded-md ">
                    ...
                    <div className="">
                        ...
                        <p>Price : ${price}</p>
                        <button className="py-1 px-5 font-semibold bg-purple-600 rounded mt-2 text-white">Add TO Card</button>
                    </div>
                </div>
